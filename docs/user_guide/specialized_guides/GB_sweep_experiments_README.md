...
- `src/ftnTheory/GBExperiments.java` — **NEW.** Experiment logic.
- `src/ftnTheory/GenModBranching.java` — **MODIFIED.** Two changes:
...
```
|GB| sweep -v 2 -a 4.0 -A 4.0 -b -0.5 0.5 -0.5 0.5 -n 30 -o holonomy_sweep.csv
```

Parameters:
- `-v 2`     : fixed traditional branch point at vertex 2
