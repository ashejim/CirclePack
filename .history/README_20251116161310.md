...
2. Start a new project by cloning a Git repository: 'File | New | Project from Version Control' You can add it directly with a cloning link, e.g., [https://github.com/ashejim/CirclePack.git](https://github.com/ashejim/CirclePack.git)
...
3. Setup as a Java project in your IDE.
   ...
   - CP uses packages not included in yout standard SDK. Add the /jar subfolder to the project depenedcies as follows: 'File | Project Structure -> Modules -> Dependencies'
...
4. Click the “+” icon → choose Library → From Maven... In the pop-up box type 'xerces:xercesImpl:2.12.2' (or whatever is missing) check “Download to: project library”, and click "OK."  
5. IntelliJ automatically downloads the Xerces JAR and adds it to your classpath. Press Apply → OK, then Build → Rebuild Project.
  
6. Run CP using SplashMain (./src/allMains/SplashMain).
