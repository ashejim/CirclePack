...
2. Start a new project by cloning a Git repository: 'File | New | Project from Version Control' You can add it directly with a cloning link, e.g., 'https://github.com/ashejim/CirclePack.git'
