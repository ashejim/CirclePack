...
### Setup as a Java project in your IDE
   ...
   2. For CirclePack some necesseary packages may not be included in your JDK by default. For example, if 'org.apache.xerces.parsers' was missing, it can be added as follows:
