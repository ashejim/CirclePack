...
4. IntelliJ automatically downloads the Xerces JAR and adds it to your classpath. Press Apply → OK, then Build → Rebuild Project.
  
5. Run CP using SplashMain (./src/allMains/SplashMain).
