...
CirclePack is a Java app, and should run on any Java platform. If not installed, download and install the lateset JRE or [JDK](https://www.oracle.com/java/technologies/downloads/).  
