...
"Since it was not initially conceived in an object-oriented way, the code is unnecessarily convoluted..." Stephenson and most every CP contributor, are mathematicians
