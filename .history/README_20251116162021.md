...
### Setup as a Java project in your IDE
   ...
   5. Click the “+” icon → choose Library → From Maven... In the pop-up box type 'xerces:xercesImpl:2.12.2' (or whatever is missing) check “Download to: project library”, and click "OK."
  
   6. IntelliJ automatically downloads the Xerces JAR and adds it to your classpath. Press Apply → OK, then Build → Rebuild Project.
   7. 1. Run CP using SplashMain (./src/allMains/SplashMain).
