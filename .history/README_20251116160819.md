...
1. Clone a repo to your [Github repo add steps here](www.google.com)

1. Start a new project by cloning a Git repository: 'File | New | Project from Version Control'
