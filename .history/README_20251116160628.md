...
For development, the CirclePack source files can be run from an IDE using SplashMain (./src/allMains/SplashMain). The additional jar files found in CirclePack/jars/.
