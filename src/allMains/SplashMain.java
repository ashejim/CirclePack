 ...
 * screen and run the real main() function.
 * 
 * @author Bradford Smith
 */
public class SplashMain {
	private static final String splashImageFilename = 
			"/Resources/Icons/GUI/CPSplash.jpg";
	...
	IOException, java.net.URISyntaxException
	{
		...
		boolean inJar=SplashMain.class.
	...
	public static void main(String[] args) {
		...
		// want locale-sensitive classes (e.g., numerical 
		// output) to be in US format
		Locale.setDefault(new Locale("en","US"));
		
		// get an object of this class to manage the 
		// splash screen.
