...
public class HoverPanel extends JPanel implements MouseListener {
	...
	// ==================== methods to override =================
	/**
	 * @aibrief Create the components for both frames (override point).
	 * Create the components for both frames
	 */
	public void initComponents() {}

	/**
	 * @aibrief Perform initial formatting of this panel on creation.
	...
	/**
	 * @aibrief Reformat this panel for the hover frame (override point).
	 * Reformat 'this' panel (if necessary)
	 */
	public void loadHover() {}

	/**
	 * @aibrief Hook for any action to take before hovering (override point).
	 * if there's some action to take before hovering
	 */
	public void hoverCall() {}

	/**
	 * @aibrief Reformat this panel for the locked frame (override point).
	 * Reformat 'this' panel (if necessary)
	 */
	...
	/**
	 * @aibrief Lock the frame with decorations and make it visible.
